...
const RoomCards: FC<Props> = (props) =>{
return (
 <>
 <div className={"font-serif p-3   h-72 pt-16 group hover:bg-primary "}>
                <div className="flex space-x-1 group-hover:text-white group-hover:border-white justify-center pb-2">
