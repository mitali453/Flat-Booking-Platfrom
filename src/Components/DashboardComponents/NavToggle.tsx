...
const NavToggle: FC<Props> = ({ sideNavToggle }) => {
        ...
        <>
            <div className="text-gray-100 bg-gray-600 body-font shadow w-full">
                <div className="flex container mx-auto justify-between p-5">
                    ...
                    <div className="flex text-white justify-end my">
  ...
  <path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z" />
                    ...
                    <Link to={""}><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 my-auto -mr-5 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
