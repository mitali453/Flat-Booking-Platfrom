...
const UploadApartPage: FC<Props> = (props) => {
    return (
        <div className="flex mx-auto">
            <section className="max-w-4xl p-6 mx-auto bg-gray-500 rounded-md shadow-md dark:bg-gray-800 mt-10">
                <h1 className="text-xl font-bold text-white capitalize dark:text-white">Upload Apartment Details</h1>
                <form>
                    <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        <div>
                            <label className="text-white dark:text-gray-200" >Name of Apartment</label>
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200" >Full Name of Owner</label>
                            <input type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                        </div>

                        <div>
                            <label className="text-white dark:text-gray-200" >Full Address</label>
                            <input type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                        </div>
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200" >Select Area</label>
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200" >Price Range of Flats</label>
                            <select className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" >
...
UploadApartPage.defaultProps = {
}
export default memo(UploadApartPage);