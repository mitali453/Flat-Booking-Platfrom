    ...
    return (
        <div className="flex items-center  w-full justify-center">
            <div className="bg-white rounded-lg py-3">
                ...
                <div className="">
                    <h3 className="text-center text-2xl sm:text-3xl text-gray-900 font-medium leading-8">Dennis Jenner</h3>
                    ...
                    <table className="mx-auto text-sm sm:text-lg my-8">
                        <tr className="">
                            ...
                            <td className="px-2 py-4">GLA University, Mathura</td>
                        </tr>
                        <tr className="">
                            <td className="px-2 py-4 text-gray-500 font-semibold">Phone</td>
                            <td className="px-2 py-4">+91 9999999999</td>
                        </tr>
                        <tr className="">
                            <td className="px-2 py-4 text-gray-500 font-semibold">Email</td>
                            <td className="px-2 py-4">abc@gmail.com</td>
                        </tr>
                    </table>
