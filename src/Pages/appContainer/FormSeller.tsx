...
const FormSeller: FC<Props> = (props) => {
    return (
        <div className="flex mx-auto">
            <section className="max-w-4xl p-6 mx-auto bg-gray-500 rounded-md shadow-md dark:bg-gray-800 mt-10">
                <h1 className="text-xl font-bold text-white capitalize dark:text-white">Seller Details</h1>
                <form>
                    <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200">Pan Card No.</label>
                            <input id="pan" type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                        </div>
                        <div>
                                ...
                                <div className="space-y-1 text-center">
                                    ...
                                    <div className="flex text-sm text-gray-600">
                                        <label htmlFor="file-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                            <span className="">Upload here</span>
                    ...
                    <div className="flex justify-end mt-6">
                        <Link to="/uploadapart"><span className="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-primary rounded-md hover:bg-yellow-700 focus:outline-none focus:bg-gray-600"><button>Save & Next</button></span> </Link>
                    </div>
                </form>
            </section>
        </div>
